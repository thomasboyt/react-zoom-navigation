...
export const timingFn = "cubic-bezier(0.4, 0.0, 0.2, 1)";
export const decelerationFn = "cubic-bezier(0.0, 0.0, 0.2, 1)";
export const accelerationFn = "cubic-bezier(0.4, 0.0, 1, 1)";
